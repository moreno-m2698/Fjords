...
If you are interested in seeing the product the link can be found [here](3.144.102.137:8000) (If the EC2 is running try using "Umbrall" as the Summoner Name and "NA1" for the tagline or try your own id if available).
